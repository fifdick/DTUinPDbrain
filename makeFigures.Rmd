...
print("percentage of tx agreeing on direction not repl. cohort and not disc. cohort")
print(formatC(100*(nrow(subset(df,agreelfc==1 & sigColLabel=="Not sig. in either cohort"))/nrow(subset(df,sigColLabel== "Not sig. in either cohort")))))
